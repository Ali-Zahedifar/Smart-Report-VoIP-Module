...
namespace SmartReport\Features\Internal\Controllers;
...
class InternalController extends Controller
{
    public function index()
    {
        ...
        try {
            ...
            // Filter only internal calls
            $facts = array_filter($facts, function ($fact) {
                return (isset($fact['direction']) ? $fact['direction'] : '') === 'int';
            });
        ...
        $this->view(':features/internal/views/index', [
